...
// ==========================================================
// ====== ADDED THIS NEW EXPORTED FUNCTION TO FIX THE ERROR ======
// ==========================================================
/**
 * Removes question number prefixes (e.g., "Q.1)") from a string.
 * This is now the single source of truth for cleaning question text.
