...
export function cacheDomElements() {
    ...
    const filterKeys = ['subject', 'topic', 'subTopic', 'difficulty', 'questionType', 'examName', 'examYear', 'tags', 'examDateShift'];
    ...
    dom.nextGroupBtn = document.getElementById('next-group-btn');
    ...
    dom.typewriterToggle = document.getElementById('typewriter-toggle');
