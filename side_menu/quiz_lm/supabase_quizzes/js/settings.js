...
export function toggleDarkMode() {
    ...
    applyTheme();
    saveState();
    setTimeout(() => toggleSettings(true), 200);
}
...
export function toggleShuffle() {
    ...
    // Target the settings panel so the alert appears on top of it.
    const targetElement = dom.settingsPanel;
...
export function toggleTypewriterEffect() {
...
function updateTypewriterToggleUI() {
    if (dom.typewriterToggle) dom.typewriterToggle.checked = state.isTypewriterEnabled;
}
