export const config = {
    ...
    filterKeys: ['subject', 'topic', 'subTopic', 'difficulty', 'questionType', 'examName', 'examYear', 'tags', 'examDateShift'],
    searchableFilterKeys: ['subject', 'topic', 'subTopic', 'examName', 'examYear', 'tags', 'examDateShift']
};
...
export function loadState() {
    try {
        ...
        if (savedStateJSON) {
            ...
            state.isTypewriterEnabled = savedState.isTypewriterEnabled !== false; // Default to true
